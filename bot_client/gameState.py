...
def get_distance(start, goal):
    ...
    d = distances.get(start, {}).get(goal)
    if d is None:
        # print("None", start, goal)
        # print("None")
        return 9999
    return d

# [3,1 4,1 2,1 1,1 1,2 1,3 1,4 1,5]
# [3,26 4,26 2,26 1,26 1,25 1,24 1,23 1,22]
# [23,1 23,2 23,3 24,3 25,3 22,1 21,1 20,1 20,2 20,3 20,4 20,5]
# [23,26 23,25 23,24 24,24 23,26 22,26 21,26 20,26 20,25 20,24 20,23 20,22]
# (3, 1), (3, 26), (23, 1), (23, 26)
...
class Location:
    ...
    def distance_to(self, other):
        try:
            ...
            if 12<= self.row <= 16 and 10 <= self.col <= 17:
                start = (11, 13)
                
            if 12<= other.row <= 16 and 10 <= other.col <= 17:
                goal = (11, 13)
    ...
    def distance_to_overload(self, other: tuple[int, int]) -> float:
        ...
        try:
            ...
            if 12<= other[0] <= 16 and 10 <= other[1] <= 17:
                goal = (11,13)
                
            d = get_distance(start, goal) 
            if d is None:
                print("error distance_to_overload")
                print((self.row, self.col), (other))
            return d 
            # print(self.row, self.col, other.row, other.col)
            # return get_distance((self.row, self.col), other) 
...
class GameState:
    ...
    def __init__(self) -> None:
        ...
        self.ready = False
        self.blockPellets = False
        self.blockSuper = True
    
    
        self.deadends_by_cluster: dict[int, set[tuple[int,int]]] = {
            0: {(3,1),(4,1),(2,1),(1,1),(1,2),(1,3),(1,4),(1,5)},
            1: {(3,26),(4,26),(2,26),(1,26),(1,25),(1,24),(1,23),(1,22)},
            2: {(23,1),(23,2),(23,3),(24,3),(25,3),
                (22,1),(21,1),(20,1),(20,2),(20,3),(20,4),(20,5)},
            3: {(23,26),(23,25),(23,24),(24,24),(22,26),
                (21,26),(20,26),(20,25),(20,24),(20,23),(20,22)},
        }
        mid_row = 31 // 2
        mid_col = 28 // 2

        # Define the four clusters by their row and column ranges.
        self.clusters = [
            {"name": "top_left", "row_range": (0, mid_row - 1), "col_range": (0, mid_col - 1)},
            {"name": "top_right", "row_range": (0, mid_row - 1), "col_range": (mid_col, 28 - 1)},
            {"name": "bottom_left", "row_range": (mid_row, 31 - 1), "col_range": (0, mid_col - 1)},
            {"name": "bottom_right", "row_range": (mid_row, 31 - 1), "col_range": (mid_col, 28 - 1)},
        ]     
        
        self.current_cluster_index = None
        
    def point_in_cluster(self, point, cluster):
        r, c = point
        return (cluster["row_range"][0] <= r <= cluster["row_range"][1] and
                cluster["col_range"][0] <= c <= cluster["col_range"][1])
